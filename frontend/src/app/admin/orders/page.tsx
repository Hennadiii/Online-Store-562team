  ...
  return (
    <section className="flex flex-col pb-10 gap-y-[30px]">
      <div className="flex items-center justify-between gap-x-3">
        <div className="w-[570px] px-[20px] py-[10px] h-[90px] bg-white border rounded-[14px] flex items-center">
          ...
          <div className="border-l ml-[34px] h-full items-center justify-center flex">
            <div className="flex px-[25px] gap-x-6 cursor-pointer">
              <p>Дата</p>
              <Image
                width={20}
                height={20}

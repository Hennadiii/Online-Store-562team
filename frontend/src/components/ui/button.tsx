...
const buttonsVariants = cva(
  "text-center px-8 py-4 uppercase text-[20px] w-full h-[56px] duration-500 flex items-center justify-center transition-colors border-[1px] border-white hover:text-accent hover:border-accent active:bg-accent active:text-white",
  {
    variants: {
      variant: {

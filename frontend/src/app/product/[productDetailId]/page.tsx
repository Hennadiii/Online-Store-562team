...
const ProductDetailPage = () => {
  ...
  return (
    <section className="mx-auto h-full max-w-[1440px] overflow-hidden px-80px">
      ...
      <AnimatedSection className="flex gap-x-8">
      ...
      <AnimatedSection
        as="p"
        className="mt-[112px] pl-[128px] pr-3 text-right text-[28px] leading-[120%]"
      >
      ...
      <AnimatedSection as="div" className="mt-[38px] flex flex-col gap-y-3">
      ...
      <AnimatedSection className="mt-[105px] w-full">
        <Slider {...settings}>
          <div>
            <Image
              height={540}
      ...
      <AnimatedSection className="mb-[130px] mt-3 flex gap-x-[51px]">
